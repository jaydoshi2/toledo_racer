...
//           </Collapsible> */}
//         </CardContent>
//         <CardContent className="mt-4 border rounded-md p-4 space-y-4">
//   {/* Hyperparameters Section (Static) */}
//   <div>
...
//         <input type="number" className="mt-1 p-2 border rounded w-full" placeholder="e.g., 100" />
//       </div>

//       <div>
//         <label className="font-semibold">Velocity Limit</label>
//         <p>Maximum allowed speed (in m/s) for the drone during flight.</p>
//         <input type="number" className="mt-1 p-2 border rounded w-full" placeholder="e.g., 15" />
//       </div>

//       <div>
//         <label className="font-semibold">Yaw Limit</label>
//         <p>Maximum rotational angle (in degrees) allowed for drone yaw.</p>
//         <input type="number" className="mt-1 p-2 border rounded w-full" placeholder="e.g., 45" />
//       </div>
...
//         <input type="number" className="mt-1 p-2 border rounded w-full" placeholder="e.g., 5" />
//       </div>
